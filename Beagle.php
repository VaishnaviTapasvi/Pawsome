...
<div class="header">
  ...
  <br>
    ...
    <div class="abc">
      <center><h1>BEAGLE</h1></center>
      <p>Beagle is a commonly known breed of dogs and has been highly preferred as a pet. Beagles are essentially small scent hounds that are similar to foxhounds in appearance. They commonly have spotted coat with certain areas in white.
        ...
        <div class="image" style="margin-left: 550px;">
          <img src="images/Beagle.jpeg" width="400" height="300">
        </div>
        <table>
          <tr>
          <th>Breed Name</th>
          ...
          <tr>
            <td>Origin</td>
            <td>United Kingdom,Great Britain, England</td>
          </tr>
          <tr>
            <td>Breed Group</td>
            <td>Hound Group</td>
          ...
          <tr>
            <td>Temperament</td>
            <td>Intelligent, Gentle, Excitable, Kid Friendly, Easy to train</td>
          </tr>
          <tr>
          ...
          <tr>
            <td>Price</td>
            <td>Rs.18, 000 –Rs. 50, 000</td>
          </tr>
        </table>
        <br>
        <br>
        <p style="font-size:xx-large;">Why should you consider having a Beagle?</p>
        <ul>
          <li>Beagles are people-friendly!</li>
          <li>Beagles love other pets as much as people!</li>
          <li>Beagles cannot live without playing!</li>
          <li>Beagles are low maintenance</li>
          <li>Beagles are cuddly pets!</li>
          <li>Beagles can be great therapists!</li>
          <li>Beagles are not fussy about food</li>
        </ul>
    </div>
    <p>&nbsp;</p>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
      ...
      <main>
            ...
            <div class="card">
                ...
                <button data-id="<?php echo $row["product_id"]; ?>" >Proceed for Payment</button>
                </a>
            </div>
            </div>
            </div>
