...
//   $upload_dir.$_FILES["imageUpload"]["name"];
  ...
  if($upload_ok==0){
    ...
    if($productname!="" && $age!="" && $gender!="" && $colour!="" &&$price!=""){
      ...
      $sql="INSERT INTO beagle(product_name,age,gender,colour,price,product_image) VALUES('$productname','$age','$gender','$colour',$price,'$product_image')";
...
<html lang="en">
    ...
    <body>
        ...
        <section id="upload_container">
            <form action="uploadbeagle.php" method="POST" enctype="multipart/form-data">
